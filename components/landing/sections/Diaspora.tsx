        ...
        <div>
          ...
          <ScrollInView delay={180} entrance="slideRight">
            <p className="mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Millions of <span className="font-semibold text-primary dark:text-primary">Africans</span> around the world want to support people and projects back home. <span className="font-semibold text-primary dark:text-primary">Givita</span> is designed for international donations, seamless currency conversion, and local disbursement &mdash; so supporters anywhere can contribute confidently to causes they care about.
            </p>
          </ScrollInView>
        </div>
