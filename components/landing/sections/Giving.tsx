    ...
    <Section id="giving" variant="sparkle">
      <div className="grid items-end gap-6 sm:grid-cols-[1fr_auto] sm:items-end">
        <div className="max-w-2xl">
          ...
          <Reveal delay={180}><p className="mt-6 text-pretty text-lg leading-relaxed text-muted-foreground">Social and gamified systems designed to celebrate generosity - without losing authenticity. Tap any feature to read more.</p></Reveal>
        </div>
        <ScrollInView delay={240} entrance="rotateIn"><div className="hidden h-32 w-48 sm:block"><IllustSparkle className="h-full w-full text-primary" /></div></ScrollInView>
      </div>
      <ScrollInView delay={260} entrance="slideUp"><FeatureAccordion features={features} /></ScrollInView>
      <Joint tone="leave" />
    </Section>
  );
}
